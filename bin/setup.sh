...
echo "  1. 外部ツール（zsh + fzf + ripgrep + tmux）"
echo "  2. Zsh環境（Oh My Zsh + Powerlevel10k + プラグイン）"
echo "  3. Vim環境（Vundle + プラグイン）"
echo "  4. Claude Code設定"
echo "  5. dotfiles設定ファイルのシンボリックリンク"
echo ""
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Step 4: Claude Code設定のセットアップ
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

echo ""
echo "┌────────────────────────────────────────────────────────────────┐"
echo "│ Step 4/4: Claude Code設定のセットアップ                            │"
echo "└────────────────────────────────────────────────────────────────┘"
echo ""
...
if [[ -f "$SCRIPT_DIR/setup_claude.sh" ]]; then
    ...
    echo "❌ エラー: setup_claude.sh が見つかりません"
    exit 1
fi
...
echo ""
echo "5. （オプション）tmux でセッション永続化："
echo "   $ tmux new -s claude     # 新しいセッションを作成"
echo "   $ claude                  # Claude Code を起動"
echo "   # Ctrl-b d でデタッチ（バックグラウンドに移行）"
echo "   $ tmux attach -t claude  # 再接続"
echo ""
echo "6. （オプション）iTerm2 ネイティブ tmux 統合："
echo "   $ tmux -CC                       # 新しい統合セッションを開始"
echo "   $ tmux -CC attach -t claude      # 既存セッションにアタッチ"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "💡 便利なコマンド"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
